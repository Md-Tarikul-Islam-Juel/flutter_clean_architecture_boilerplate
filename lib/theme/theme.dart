...
import '../data/data_sources/Local/cache_box_storage_handler.dart';
...
class DatabaseService {
  ...
  get savedTheme => ref.watch(hiveCacheBoxProvider).get(KStrings.theme);

  void initTheme() {
    ref.watch(hiveCacheBoxProvider).put(KStrings.theme, 'light');
  }

  void toggleSaveTheme(String mode) =>
      ref.watch(hiveCacheBoxProvider).put(KStrings.theme, mode);
}

class MyTheme {
  static final lightTheme = FlexThemeData.light(
    colors: const FlexSchemeColor(
      primary: Color(0xFF3DAE58),
