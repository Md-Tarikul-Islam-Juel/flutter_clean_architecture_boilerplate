...
import '../presentation/MainNavBare/main_nav.dart';
import '../presentation/MainNavBare/main_nav_with_rive.dart';
import '../presentation/onborad/Page/onboard_screen.dart';
import '../presentation/splash/Page/splash_screen.dart';
import '../presentation/home/Page/xyz.dart';
...
class RouterNotifier extends ChangeNotifier {
  ...
  List<GoRoute> get _routes => [
        ...
        GoRoute(
          path: xyz.route,
          builder: (context, state) => const xyz(),
        ),
        // GoRoute(
